  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: "Main3",
          component: () =>
            import(/* webpackChunkName: "about" */ "@/components/Main3.vue")
        },
        {
          path: "2-1",
          name: "Main1",
          component: () =>
            import(/* webpackChunkName: "about" */ "@/components/Main1.vue")
        },
        {
          path: "2-2",
          name: "Main2",
          component: () =>
            import(/* webpackChunkName: "about" */ "@/components/Main2.vue")
        },
        {
          path: "2-3",
          name: "Main3",
